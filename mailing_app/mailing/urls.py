...
urlpatterns = [
    ...
    path('client/<int:pk>/update_mailing', MailingSettingsUpdate.as_view(), name='update_mailing'),
    path('client/<int:pk>/delete_mailing', MailingSettingsDelete.as_view(), name='delete_mailing'),
]
