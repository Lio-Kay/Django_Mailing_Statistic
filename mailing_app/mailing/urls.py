...
urlpatterns = [
    ...
    path('', cache_page(1)(MailingSettingsList.as_view()), name='mailing_list'),
    ...
    path('clients', cache_page(1)(ClientList.as_view()), name='clients_list'),
    ...
    path('mailing_logs', cache_page(1)(MailingLogsList.as_view()), name='mailing_logs_list'),
]
