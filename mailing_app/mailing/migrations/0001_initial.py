    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ManyToManyField(blank=True, null=True, to='mailing.client')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('settings', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mailing.mailingsettings')),
            ],
            options={
